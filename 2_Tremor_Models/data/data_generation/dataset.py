...
class TremorDataset(Dataset):
    ...
    def __init__(self,
        ...
        # 2. Init list for all data samples
        all_samples = []
        ...
        for movement_idx, movement_name in enumerate(movement_names):
            ...
            def process_npz(file, label):
                """Load (Left, Right) signals, handedness, and subject_id from .npz file"""
        ...
        # Note: self.metadata is removed here.
    ...
    def __getitem__(self, index):
        ...
        # Metadata is no longer returned or stored.
