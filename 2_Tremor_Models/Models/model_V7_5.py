...
class TremorNetAdvanced_V7_5(nn.Module):
    ...
    def __init__(self, dropout=0.45, use_fft=True):
        ...
        # Processes dominant hand with more parameters
        ...
        # Squeeze-excitation for dominant path
    ...
    def _compute_fft_features(self, x):
        ...
        # Focus on tremor-relevant frequencies (0.5-10 Hz)
    ...
    def _compute_statistical_features(self, x):
        ...
        skew = (x_centered ** 3).mean(dim=2) / (std ** 3 + 1e-6)
        
        # Kurtosis (tailedness - tremor has spikes)
        kurt = (x_centered ** 4).mean(dim=2) / (std ** 4 + 1e-6)
    ...
    def forward(self, x, handedness, mixup_lambda=None):
        ...
        # Optional: Mixup augmentation during training
        ...
        # Frequency features (both wrists)
        ...
        # Bilateral coordination (cross-attention between wrists)
