...
│    └─Sequential (0)                         [1, 6, 2048]         [1, 128, 1024]       --                   True
...
│    └─Dropout (1)                            [1, 128, 1024]       [1, 128, 1024]       --                   --
│    └─Sequential (2)                         [1, 128, 1024]       [1, 256, 512]        --                   True
│    │    └─Conv1d (0)                        [1, 128, 1024]       [1, 256, 512]        164,096              True
│    │    └─BatchNorm1d (1)                   [1, 256, 512]        [1, 256, 512]        512                  True
│    │    └─ReLU (2)                          [1, 256, 512]        [1, 256, 512]        --                   --
│    │    └─Dropout (3)                       [1, 256, 512]        [1, 256, 512]        --                   --
│    └─Dropout (3)                            [1, 256, 512]        [1, 256, 512]        --                   --
│    └─Sequential (4)                         [1, 256, 512]        [1, 512, 256]        --                   True
│    │    └─Conv1d (0)                        [1, 256, 512]        [1, 512, 256]        393,728              True
│    │    └─BatchNorm1d (1)                   [1, 512, 256]        [1, 512, 256]        1,024                True
│    │    └─ReLU (2)                          [1, 512, 256]        [1, 512, 256]        --                   --
│    │    └─Dropout (3)                       [1, 512, 256]        [1, 512, 256]        --                   --
│    └─Sequential (5)                         [1, 512, 256]        [1, 512, 256]        --                   True
│    │    └─Conv1d (0)                        [1, 512, 256]        [1, 512, 256]        786,944              True
│    │    └─BatchNorm1d (1)                   [1, 512, 256]        [1, 512, 256]        1,024                True
│    │    └─ReLU (2)                          [1, 512, 256]        [1, 512, 256]        --                   --
│    │    └─Dropout (3)                       [1, 512, 256]        [1, 512, 256]        --                   --
│    └─Dropout (6)                            [1, 512, 256]        [1, 512, 256]        --                   --
├─GRU (gru)                                   [1, 256, 512]        [1, 256, 512]        3,548,160            True
├─MultiheadAttention (multihead_attn)         --                   [1, 256, 512]        1,050,624            True
├─Sequential (attention_proj)                 [1, 256, 512]        [1, 256, 512]        --                   True
│    └─Linear (0)                             [1, 256, 512]        [1, 256, 512]        262,656              True
│    └─Tanh (1)                               [1, 256, 512]        [1, 256, 512]        --                   --
│    └─Dropout (2)                            [1, 256, 512]        [1, 256, 512]        --                   --
...
=============================================================================================================================
Total params: 7,267,459
Trainable params: 7,267,459
Non-trainable params: 0
